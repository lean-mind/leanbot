...
export const GratitudeSummaryView = async ({
  ...
  sent,
  received,
}: GratitudeSummaryViewProps): Promise<SlackView> => {
      ...
      elements: [
        {
          type: "image",
          image_url:
            "https://static3.lasprovincias.es/www/multimedia/202010/10/media/cortadas/gato-ksgH-U1204237773070s-1248x770@Las%20Provincias.jpg",
          alt_text: "cute cat",
        },
        {
          type: "mrkdwn",
