...
describe("Slack service:", () => {
  ...
  describe("sendMessage method", () => {
    ...
    it("should send a view", async () => {
      ...
      expect(axiosMock.post).toBeCalledWith(
        endpoint,
        { channel, blocks: (view as SlackView).blocks, text: null },
        { headers }
      )
  ...
  describe("updateMessage method", () => {
    ...
    it("should update with a simple text message", async () => {
      ...
      expect(axiosMock.post).toBeCalledWith(
        responseUrl,
        { replace_original: true, blocks: undefined, text },
        { headers }
      )
    })
    ...
    it("should update with a view", async () => {
      ...
      expect(axiosMock.post).toBeCalledWith(
        responseUrl,
        {
          ...
          blocks: (view as SlackView).blocks,
          text: null,
        },
        { headers }
      )
  ...
  describe("getCommunityMembers method", () => {
    ...
    it("should retrieve all community members", async () => {
      ...
      expect(axiosMock.get).toHaveBeenNthCalledWith(1, endpointToGetChannels, {
        params: { team_id: teamId },
        headers,
      })
      expect(axiosMock.get).toHaveBeenNthCalledWith(2, endpointToGetMembersByChannel, {
